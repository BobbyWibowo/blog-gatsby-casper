---
title: "Accounts that are being primarily used to upload full-length anime series will be deleted in the future"
...
**TL;DR.** Please stop dumping full seasons of anime into the safe, kthxbye.

---

Hey there folks, another announcement here.

In recent months, I've starting seeing random sudden spikes in the safe's disk usage. When I investigated further, I then noticed a few accounts with very high total disk usages, as compared to other accounts in the safe.
